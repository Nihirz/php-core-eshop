...
<body>
  <form  method="POST" enctype="multipart/form-data">
    <table border="1" width="1000px" >
      <tr class="mt5"><th>Title<div class="text-right"> <a href="products.php" class=" btn btn-dark">Back</a></div></th></tr>
      <tr>
        <td>
          <textarea rows="5" cols="25"  class="editor"  name="name" value=""><?php echo $row['name'];?></textarea>
        </td>
      </tr>
      ...
      <tr>
        <td>
          <textarea rows="5" cols="25"  class="editor"  name="description" value=""><?php echo $row['description'];?></textarea>
        </td>
      </tr>
      <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
          <script>
...
if (isset($_POST['update'])) {
 ...
 $description=$_POST['description'];
  ...
  if ($file == "")
  {
   $update = "UPDATE `slider` SET `title`='$title',`description`='$description',`img`='$target_file' WHERE id = '$GetId' ";
     $conn->query($update);
